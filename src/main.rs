...
use crate::pages::unclear::unclear;
use crate::pages::unclear::unclear_post;
...
async fn main() {
    ...
    app = app
        ...
        .route("/statement/:id/unclear", get(unclear))
        .route("/statement/:id/unclear", post(unclear_post))
